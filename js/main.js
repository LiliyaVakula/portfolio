...
var dictionary = {
  en: {
    ...
    caseBtn: 'Case Study',
    caseTitle1: 'The World of Toys',
    caseSubtitle1: 'My first WordPress project.',
    caseTitle2: 'Ciel De Paris',
    caseSubtitle2: 'French restaurant website.',
  ...
  ru: {
    ...
    caseBtn: 'Перейти',
    caseTitle1: 'The World of Toys',
    caseSubtitle1: 'Мой первый проект на WordPress.',
    caseTitle2: 'Ciel De Paris',
    caseSubtitle2: 'Cайт французского ресторана.',
    caseTitle3: 'BWA - drones',
